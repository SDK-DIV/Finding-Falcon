...
class Destination extends React.Component {
    static PropTypes = {
        planets: this.PropTypes.array,
        vehicle: this.PropTypes.array,
        index: this.PropTypes.array
    }
    ...
    render() {
        ...
        let selectValue = this.props.state.destinations[this.props.index].seleectedPlanet || SELECT_DEST_MSG;
        return (
            <div className="destination">
                <div className="destinationSelect">
                    <label className={this.getClassName()} htmlFor="outlined-age-native-simple">
                        {SELECT_DEST_MSG}
                    </label>
                    <div value={selectedValue} onChange={this.onDestinationChange} label="Destination">
                        <option value={selectValue}>{selectedValue}</option>
                        {optionItems}
                    </div>
                </div>
                {this.showVehicle() && (
